...
class Server() {
  companion object {
     ...
     *
     * This method configures the server and connects it to the standard input and output streams. It will handle
     * listing prompts, tools, and resources automatically.
     */
